    ...
    <div class="allNews">
        ...
        <div class="d-flex flex-column newsDetailContainer  m-auto">
            <div class="d-flex flex-row justify-content-center roe ms-3 align-center">
                ...
                <p class="titleInfo">{{ $message->title }}</p>
            </div>
            <div class="d-flex flex-row justify-content-center roe ms-3 align-center">
                <label for="detailTital" class="detailTital  me-auto">{{ __('messageZY.status') }}</label>

                <p class=" titleInfo">{{ $message->status }}</p>
            </div>
            <div class="d-flex flex-row justify-content-center roe ms-3 align-center">
                <label for="detailTital" class="detailTital me-auto ">{{ __('messageZY.requestedat') }}</label>

                <p class=" titleInfo date dateM">{{ $message->created_at }}</p>
            </div>
        </div>
    </div>
@endsection
