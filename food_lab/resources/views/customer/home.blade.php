     ...
     <nav class="navbar navbar-expand-lg container-fluid py-3">
        ...
        <div class="collapse navbar-collapse text-uppercase fw-bolder" id="navbarNav">
            <ul class="navbar-nav w-100 justify-content-around align-items-center border-0 rounded py-3 navs">
                ...
                <li class="nav-item">
                    <a class="nav-link texts" id="informButton">{{ __('messageMK.inform') }}</a>
                </li>
...
<div id="informAlert" class="informAlert">
    ...
    <div class="headerInform d-flex flex-row justify-content-center align-items-center w-50 mt-2">
        <div class="ms-2 me-5">
            <p class="fw-bolder fs-5  infromTitle" id="clickNews">{{ __('messageMK.new') }}</p>
        </div>
        <div class="ms-2 me-2">
            <p class="fw-bolder fs-5 infromTitle" id="clickMessages">{{ __('messageMK.message') }}</p>
        </div>
        <div class="ms-5 me-2">
            <p class="fw-bolder fs-5 infromTitle" id="clickTracks">{{ __('messageMK.track') }}</p>
        </div>
    </div>
    <div class="forNews d-flex flex-column" id="forNews">
        ...
        @endforelse
        <button class="btn mb-2 alertButton" > {{__('messageZY.more')}}</button>
    </div>
