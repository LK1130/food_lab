...
@section('body')
    <div class="col-md-10">
        ...
        {{-- Status Start --}}
        <div class="status text fs-2 fw-bold mb-4">{{ __('messageZN.Status') }}</div>
        <div class="row align-items-start me-4">
            <div class="col a ">
                <div class="text-center pb-3">
                    <p class=" numbers">10</p>
                    <p class="fs-4">{{ __('messageZN.Total Transaction') }}</p>
            ...
            <div class="col a ms-3">
                <div class="text-center pb-3">
                    ...
                    <p class="fs-4">{{ __('messageZN.Total User Register') }}</p>
                    <a href="" class="fs-5">{{ __('messageZN.See More Detail') }}</a>
                </div>
            </div>
            <div class="col a ms-3">
                <div class="text-center pb-3">
                    ...
                    <p class="fs-4">{{ __('messageZN.Coin Rate') }}</p>
                    <a href="" class="fs-5">{{ __('messageZN.See More Detail') }}</a>
                </div>
            </div>
            <div class="col a ms-3">
                <div class="text-center pb-3">
                    ...
                    <p class="fs-4">{{ __('messageZN.Today Order') }}</p>
                    <a href="" class="fs-5">{{ __('messageZN.See More Detail') }}</a>
                </div>
            </div>
            <div class="col a ms-3">
                <div class="text-center ">
                    ...
                    <p class="fs-4 fw-bold">1.Idiot Sandwich</p>
                    <p class="fs-4 fw-bold">2.Moron Burger</p>
                    <p class="fs-4 fw-bold">3.Ad</p>
                </div>
            </div>
        </div>
        {{-- Status End --}}
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                {{-- Customer Info --}}
                <div class="status text fs-3 fw-bold mb-2">{{ __('messageZN.Customer Info') }}</div>
                <table class="table boxshad">
                    <thead>
                        <tr class="tableheader">
                            <th scope="col">No.</th>
        ...
        <div class="row">
            <div class="col-md-6">
                {{-- Product List --}}
                <div class="status text fs-3 fw-bold mb-2">{{ __('messageZN.Product List') }}</div>
                <table class="table boxshad">
                    <thead>
                        <tr class="tableheader">
                            <th scope="col">No.</th>
            ...
            <div class="col-md-6">
                {{-- Coin Charge List --}}
                <div class="status text fs-3 fw-bold mb-2">{{ __('messageZN.Coin Charge List') }}</div>
                <table class="table boxshad">
                    <thead>
                        <tr class="tableheader">
                            <th scope="col">No.</th>
