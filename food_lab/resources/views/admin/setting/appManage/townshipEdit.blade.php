        ...
        <form action="{{ route('township.update', $township->id) }}" method="POST">
            ...
            <div>
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="township_name" value="{{ $township->township_name }}">
                    @error('township_name')
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="dlprice" value="{{ $township->delivery_price }}">
                    @error('dlprice')
                        <li class="text-danger ">{{ $message }}</li>
                    @enderror
                </div>
