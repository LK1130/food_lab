...
<div class="navBar">
    ...
    <div class="adminAddForm">
        <form action="{{ route('suggest.update',$suggest->id)}}" method="POST">  
            @csrf
            @method('PUT')
                ...
                <div>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="suggest" name="suggest_type" value="{{ $suggest->suggest_type }}">
                            @error('suggest_type')
